...
module.exports = {
    ...
    devServer: {
        ...
        port: 9080,
        hot: true,
        // fix vue-router history mode 404
        // development mode config see - https://webpack.docschina.org/configuration/dev-server/#devserverhistoryapifallback
        // production mode config see - https://v3.router.vuejs.org/zh/guide/essentials/history-mode.html#%E5%90%8E%E7%AB%AF%E9%85%8D%E7%BD%AE%E4%BE%8B%E5%AD%90
        historyApiFallback: {
            rewrites: [
                { from: /^\/$/, to: 'index.html' },
            ],
    ...
    resolve: {
        ...
        alias: {
            ...
            // see - https://stackoverflow.com/questions/47332728/you-are-using-the-runtime-only-build-of-vue-where-the-template-compiler-is-not-a
            vue: 'vue/dist/vue.js',
            // package path config
    ...
    plugins: [
        ...
        // copy public resources to the product directory
        ...
        // Copy and apply other rules you have defined to the corresponding language blocks in the vue file
        // config see - https://vue-loader.vuejs.org/zh/guide/#%E6%89%8B%E5%8A%A8%E8%AE%BE%E7%BD%AE
        new VueLoaderPlugin(),
        // webpack project read .env file
        // config see - https://github.com/mrsteele/dotenv-webpack
        new DotenvWebpack({
            path: './.env.dev'
        })
    ],
    optimization: {
        /*
            ...
            runtimeChunk选项的作用是将运行时代码提取到单独的文件中，以便缓存利用和减小构建输出的文件大小
            默认值是 false：每个入口 chunk 中直接嵌入 runtime（包含webpack的模块加载器和模块解析器）:runtime.[hash].js
        ...
        */
        ...
        // see - https://webpack.docschina.org/configuration/optimization/#optimizationmoduleids
